...
// Uploads
i.appendChild(s.divItems),s.EventDelete(),s.createActionSend(e)}),n.readAsDataURL(e[0]),this.hideContenContainer()}},{key:"hideContenContainer",value:function(){this.element.querySelector(this.fieldDrop_content).classList.add("hide")}},{key:"sendFile",value:function(e,t){var n=this,o=new l.default;return new Promise(function(t,i){o.upload(n.options.url,e).then(function(e){t(e)},function(e){i(e)})})}},{key:"humanFileSize",value:function(e){var t=Math.floor(Math.log(e)/Math.log(1024));return 1*(e/Math.pow(1024,t)).toFixed(2)+" "+["B","kB","MB","GB","TB"][t]}}]),t}();t.exports=d},{"./ajax":2,"tiny-emitter":1}]},{},[3])(3)});